// Package motion_state implements motion state actions.
//
// Motion states define the possible states in a motion workflow.
...
func init() {
	a := action.NewCreateAction("motion_state.create", model.MustGet("motion_state"))
	...
	a.Schema = map[string]any{
		...
		"required": []string{"workflow_id", "name", "weight"},
	}
