...
CREATE TRIGGER tr_log_poll_config_stv_scottish_t_poll_id AFTER INSERT OR UPDATE OF poll_id OR DELETE ON poll_config_stv_scottish_t
FOR EACH ROW EXECUTE FUNCTION log_modified_related_models('poll', 'poll_id');
...
FIELD 1GrR:1rR,1rR,1rR,1rR,1rR => poll/config_id:-> poll_config_approval/poll_id,poll_config_selection/poll_id,poll_config_rating_score/poll_id,poll_config_rating_approval/poll_id,poll_config_stv_scottish/poll_id
...
FIELD 1rR:1GrR => poll_config_stv_scottish/poll_id:-> poll/config_id
